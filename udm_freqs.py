...
text = re.sub('[\[\]]+', '', text)
words = re.findall('([а-яёА-ЯЁӜӝӞӟӤӥӦӧӴӵ0-9]+-*[а-яёА-ЯЁӜӝӞӟӤӥӦӧӴӵ]*)', text)
freq = {}
...
f2 = open('sorted_correct_2.txt', 'w', encoding='utf-8')
